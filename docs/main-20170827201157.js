...
var _user$project$Workout$expectedWorkouts = F2(
	function (miles, date) {
		var _p0 = miles;
		if (_p0.ctor === '[]') {
			return {ctor: '[]'};
			...
			return {
				...
				_0: {
					date: date,
					workout: {mileage: _p0._0, notes: ''}
				},
				_1: A2(
					_user$project$Workout$expectedWorkouts,
					_p0._1,
					A3(_justinmimbs$elm_date_extra$Date_Extra$add, _justinmimbs$elm_date_extra$Date_Extra$Day, 1, date))
			};
		}
	});
var _user$project$Workout$Workout = F2(
	function (a, b) {
		return {mileage: a, notes: b};
	});
var _user$project$Workout$DailyWorkout = F2(
	function (a, b) {
		return {date: a, workout: b};
	});
var _user$project$Workout$Plan = F2(
	function (a, b) {
		return {name: a, routine: b};
	});
var _user$project$Workout$Routine = F2(
	function (a, b) {
		return {actual: a, expected: b};
	});
var _user$project$Workout$Kilometers = function (a) {
	return {ctor: 'Kilometers', _0: a};
};
var _user$project$Workout$Miles = function (a) {
	return {ctor: 'Miles', _0: a};
};
var _user$project$Workout$initWorkout = function (date) {
	return A2(
		_user$project$Workout$DailyWorkout,
		date,
		A2(
			_user$project$Workout$Workout,
			_user$project$Workout$Miles(0),
			''));
};
var _user$project$Workout$convert = F2(
		...
		return A2(
			...
			function (e) {
				var _p1 = A2(
					...
					function (a) {
						return _elm_lang$core$Native_Utils.eq(a.date, e.date);
					},
					actual);
				if (_p1.ctor === 'Just') {
					return {actual: _p1._0, expected: e};
				} else {
					return {
						actual: _user$project$Workout$initWorkout(e.date),
						expected: e
					};
				}
			},
...
var _user$project$Workout$routines = F3(
	function (plan, workouts, startDate) {
		return A2(
			_user$project$Workout$convert,
			A2(
				_user$project$Workout$expectedWorkouts,
				_elm_lang$core$List$concat(plan.routine),
				startDate),
			workouts);
	});

var _user$project$Plans$plan = {
	name: 'Ultraladies 100 miles',
	routine: {
		ctor: '::',
		_0: {
			ctor: '::',
			_0: _user$project$Workout$Miles(0),
			_1: {
				ctor: '::',
				_0: _user$project$Workout$Miles(4),
				_1: {
					ctor: '::',
					_0: _user$project$Workout$Miles(6),
					_1: {
						ctor: '::',
						_0: _user$project$Workout$Miles(4),
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$Workout$Miles(16),
								_1: {
									ctor: '::',
									_0: _user$project$Workout$Miles(10),
									_1: {ctor: '[]'}
								}
							}
						}
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$Workout$Miles(18),
									_1: {
										ctor: '::',
										_0: _user$project$Workout$Miles(10),
										_1: {ctor: '[]'}
			...
			_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _user$project$Workout$Miles(20),
										_1: {
											ctor: '::',
											_0: _user$project$Workout$Miles(10),
											_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$Workout$Miles(2),
							_1: {
								ctor: '::',
								_0: _user$project$Workout$Miles(4),
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _user$project$Workout$Miles(8),
												_1: {ctor: '[]'}
											}
										}
									}
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _user$project$Workout$Miles(12),
													_1: {ctor: '[]'}
												}
											}
										}
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _user$project$Workout$Miles(22),
													_1: {
														ctor: '::',
														_0: _user$project$Workout$Miles(12),
														_1: {ctor: '[]'}
												...
												_1: {
													...
													_1: {
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _user$project$Workout$Miles(25),
																_1: {
																	ctor: '::',
																	_0: _user$project$Workout$Miles(13),
																	_1: {ctor: '[]'}
																}
															}
														}
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_1: {
																				ctor: '::',
																				_0: _user$project$Workout$Miles(28),
																				_1: {
																					ctor: '::',
																					_0: _user$project$Workout$Miles(15),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _user$project$Workout$Miles(30),
																								_1: {
																									ctor: '::',
																									_0: _user$project$Workout$Miles(15),
																									_1: {ctor: '[]'}
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_1: {
																										...
																										_0: {
																											ctor: '::',
																											_0: _user$project$Workout$Miles(5),
																											_1: {
																												ctor: '::',
																												_0: _user$project$Workout$Miles(3),
																												_1: {
																													ctor: '::',
																													_0: _user$project$Workout$Miles(2),
																													_1: {
																														...
																														_1: {
																															...
																															_1: {
																																ctor: '::',
																																_0: _user$project$Workout$Miles(100),
																																_1: {
																																	ctor: '::',
																																	_0: _user$project$Workout$Miles(0),
																																	_1: {ctor: '[]'}
...
var _user$project$Main$viewNotes = function (routine) {
	return A2(
		_elm_lang$html$Html$input,
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$value(routine.actual.workout.notes),
					_1: {
						ctor: '::',
...
var _user$project$Main$viewDistance = function (mileage) {
	var copy = function () {
		var _p0 = mileage;
		if (_p0.ctor === 'Miles') {
			return A2(
...
var _user$project$Main$optionForMileage = F2(
	function (actual, expected) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(unit),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(actual, expected)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$editDistance = function (mileage) {
		...
		_1: {
			...
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: A2(
						_user$project$Main$optionForMileage,
						mileage,
						_user$project$Workout$Miles(distance)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Main$optionForMileage,
							mileage,
							_user$project$Workout$Kilometers(distance)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Main$viewRoutine = function (routine) {
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						_elm_lang$core$Basics$toString(
							_elm_lang$core$Date$dayOfWeek(routine.expected.date))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'MM/dd', routine.expected.date)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$viewDistance(routine.expected.workout.mileage),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(routine.expected.workout.notes),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								_user$project$Main$editDistance(routine.actual.workout.mileage)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$td,
									...
									{
										ctor: '::',
										_0: _user$project$Main$viewNotes(routine),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				},
				{
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Scheduled'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$List$map,
								_user$project$Main$viewRoutine,
								A3(_user$project$Workout$routines, model.plan, model.workouts, model.startDate))),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Main$date = function (s) {
	return A2(
		_elm_lang$core$Result$withDefault,
		_elm_lang$core$Date$fromTime(0),
		_elm_lang$core$Date$fromString(s));
};
var _user$project$Main$workouts = {
	ctor: '::',
	_0: {
		date: _user$project$Main$date('2017/01/01'),
		workout: {
			mileage: _user$project$Workout$Miles(1.0),
			notes: 'hard and hot'
		}
	},
	_1: {
		ctor: '::',
		_0: {
			date: _user$project$Main$date('2017/01/02'),
			workout: {
				mileage: _user$project$Workout$Kilometers(2.0),
				notes: 'nice and easy'
			}
		},
		_1: {ctor: '[]'}
...
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {plan: a, workouts: b, startDate: c};
	});
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: A3(
		_user$project$Main$Model,
		_user$project$Plans$plan,
		_user$project$Main$workouts,
		_user$project$Main$date('2016/12/27')),
